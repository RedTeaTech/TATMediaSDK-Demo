...
static inline NSDictionary *TATSlotIdInfo() {
    return @{@(TATSimpleAdTypeThinBanner): @"321995", @(TATSimpleAdTypeBanner): @"321997", @(TATSimpleAdTypeFloat): @"321998", @(TATSimpleAdTypeCustom): @"322001", @(TATSimpleAdTypeLaunch): @"322000", @(TATSimpleAdTypeInterstitial): @"321996"};
}
